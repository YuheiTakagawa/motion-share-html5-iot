...
var bluetoothFanc = {
  ...
  bindEvents: function() {
    ...
    $('#DeviceSelects').on('change',this.connect);
  ...
  connect: function(e) {
    //接続したデバイスの情報を取得
    var deviceName = document.DeviceSelects.value;
    var deviceId = document.DeviceSelects.text;
  ...
  var updateTag={
    ...
    searchResult: function(devices){
      var select=document.getElementById('DeviceSelects');
